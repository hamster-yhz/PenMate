...
class AgentRunRetryServiceTest {
    ...
    private final AgentRunRetryService service = new AgentRunRetryService(runs, successors);
    ...
    void locks_terminal_predecessor_and_creates_successor_from_immutable_input() {
        ...
        AgentRun result = service.retry(10L, 60L, 50L, "trace-2");
    ...
    void repeated_retry_returns_existing_successor_without_dispatching_again() {
        ...
        assertThat(service.retry(10L, 60L, 50L, "trace-3")).isSameAs(successor);
    ...
    void completed_run_is_eligible_for_reexecution() {
        ...
        assertThat(service.retry(10L, 60L, 50L, null)).isSameAs(successor);
    }
    ...
    void rejects_non_terminal_run() {
        ...
        assertThatThrownBy(() -> service.retry(10L, 60L, 50L, "trace-2"))
    ...
    void rejects_retry_by_another_user() {
        ...
        assertThatThrownBy(() -> service.retry(10L, 60L, 99L, "trace-2"))
                .isInstanceOf(BusinessException.class)

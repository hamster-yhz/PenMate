...
class AgentTurnAppServiceTest {
    ...
    private static SessionStyleBindingAppService bindingAppServiceWithBoundStyle(Long boundStyleId) {
        ...
        when(repository.insertRuntimeTask(org.mockito.ArgumentMatchers.anyLong(), org.mockito.ArgumentMatchers.anyLong(), org.mockito.ArgumentMatchers.anyLong(), org.mockito.ArgumentMatchers.anyLong(), org.mockito.ArgumentMatchers.anyString(), org.mockito.ArgumentMatchers.anyString(), org.mockito.ArgumentMatchers.nullable(String.class), org.mockito.ArgumentMatchers.anyLong(), org.mockito.ArgumentMatchers.nullable(String.class))).thenReturn(1);

    ...
    private static void seedRows() throws Exception {
        try (Connection connection = sqlSessionFactory.getConfiguration().getEnvironment().getDataSource().getConnection();
            ...
            statement.execute("""
                    ...
                    (88001, 10001, 8001, 7001, 'book_crud', '{}', '{}', 1001, 'trace-1', 'idem-1', 'pending', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
                    (88002, 10001, 8002, 7002, 'book_crud', '{}', '{}', 1001, 'trace-2', 'idem-2', 'executing', CURRENT_TIMESTAMP, TIMESTAMPADD(MINUTE, -5, CURRENT_TIMESTAMP)),
                    (88003, 10001, 8003, 7003, 'book_crud', '{}', '{}', 1001, 'trace-3', 'idem-3', 'executing', CURRENT_TIMESTAMP, TIMESTAMPADD(MINUTE, -30, CURRENT_TIMESTAMP)),
                    (88004, 10001, 8004, 7004, 'book_crud', '{}', '{}', 1001, 'trace-4', 'idem-4', 'executing', CURRENT_TIMESTAMP, TIMESTAMPADD(MINUTE, -20, CURRENT_TIMESTAMP)),
                    (88005, 10001, 8005, 7005, 'book_crud', '{}', '{}', 1001, 'trace-5', 'idem-5', 'failed', CURRENT_TIMESTAMP, TIMESTAMPADD(MINUTE, -40, CURRENT_TIMESTAMP))
                    """);
        }
    }
}

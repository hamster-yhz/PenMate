...
import { hasObjectKeyInStorageUrl, normalizeObjectStorageUrl, resolveDirectUploadTarget } from '../workbenchStorage'
...
describe('workbenchStorage', () => {
  ...
  it('should_prefix_bare_storage_host_with_default_protocol', () => {
    expect(normalizeObjectStorageUrl('localhost:9000/read/object-key')).toBe('https://localhost:9000/read/object-key')
  })

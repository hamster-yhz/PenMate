...
| Model | `interfaces/api/model/ModelController.java` | `application/model/ModelApplicationService.java` | `model_providers`、`model_provider_models`、`model_user_api_keys`、`model_project_policies` |
